...
```python
from plaza.types import AutocompleteResult, GeocodeResult, GeocodingFeature, ReverseGeocodeResult
```
...
- <code title="post /api/v1/geocode/batch">client.geocode.<a href="./src/plaza/resources/geocode.py">batch</a>(\*\*<a href="src/plaza/types/geocode_batch_params.py">params</a>) -> object</code>
...
```python
from plaza.types import MatrixRequest, MatrixResult, NearestResult, RouteRequest, RouteResult
```

Methods:

- <code title="get /api/v1/isochrone">client.routing.<a href="./src/plaza/resources/routing.py">isochrone</a>(\*\*<a href="src/plaza/types/routing_isochrone_params.py">params</a>) -> <a href="./src/plaza/types/geo_json_feature.py">GeoJsonFeature</a></code>
...
```python
from plaza.types import OverpassQuery, SparqlQuery, SparqlResult
```
